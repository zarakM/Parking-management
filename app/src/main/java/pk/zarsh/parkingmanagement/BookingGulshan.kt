...
class BookingGulshan : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_booking_gulshan)

        var list = ArrayList<_BookingDetail?>()
        val ref = FirebaseDatabase.getInstance().getReference("Booking_details/Gulshan")
